...
from training.constants import (
    ...
    LIGHTS_OUT_REGULAR_TOKENIZER_DIR, LIGHTS_OUT_REGULAR_DATA_DIR,
)
...
DATA_CONFIGS = {
    "default": {
        "jsonl_path": f"{LIGHTS_OUT_REGULAR_DATA_DIR}/tokenized.jsonl",
        "splits_path": f"{LIGHTS_OUT_REGULAR_DATA_DIR}/tokenized.splits.json",
    },
}
...
def make_experiment(exp: dict) -> tuple[str, dict]:
    ...
    config = {
        ...
        "paths": {
            ...
            "tokenizer_dir": LIGHTS_OUT_REGULAR_TOKENIZER_DIR,
            "output_dir": f"scratch_data/training_outputs/lights_out_regular/{name}",
        ...
        "wandb": {
            "project": "plan-verification-lights-out-regular",
            "run_name": name,
        },
    }
    return name, config
