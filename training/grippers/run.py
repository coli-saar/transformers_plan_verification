...
from training.constants import (
    ...
    GRIPPERS_TOKENIZER_DIR, GRIPPERS_DATA_BASE,
)
...
DATA_CONFIGS = {
    "wf": {
        "jsonl_path": f"{GRIPPERS_DATA_BASE}/grippers_heavy_wf_deanonym/tokenized.jsonl",
        "splits_path": f"{GRIPPERS_DATA_BASE}/grippers_heavy_wf_deanonym/tokenized.splits.json",
    },
    "df": {
        "jsonl_path": f"{GRIPPERS_DATA_BASE}/grippers_heavy_df_deanonym/tokenized.jsonl",
        "splits_path": f"{GRIPPERS_DATA_BASE}/grippers_heavy_df_deanonym/tokenized.splits.json",
    },
}
...
def make_experiment(exp: dict) -> tuple[str, dict]:
    ...
    # Build name
    name = f"{e['data']}_l{e['n_layer']}_h{e['n_embd']}_lr{format_lr(e['lr'])}_bs{e['batch_size']}_wd{e['wd']}_ape"
    ...
    config = {
        ...
        "paths": {
            ...
            "tokenizer_dir": GRIPPERS_TOKENIZER_DIR,
            "output_dir": f"scratch_data/training_outputs/grippers_new/{name}",
        ...
        "wandb": {
            "project": "plan-verification-grippers-new",
            "run_name": name,
        },
    }
    return name, config
